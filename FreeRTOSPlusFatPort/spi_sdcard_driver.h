...
__packed typedef union sppisd_r1_u {
...
__packed typedef struct sppisd_r3_s {

    spisd_r1_t r1;
    uint32_t ocr;
} spisd_r3_t;

__packed typedef struct sppisd_r7_s {
