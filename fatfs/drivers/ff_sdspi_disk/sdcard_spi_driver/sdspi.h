...
typedef enum _sdspi_status
{
    ...
    kStatus_SDSPI_SetFrequencyFailed = 100, /*!< Set frequency failed */
    kStatus_SDSPI_ExchangeFailed = 101,     /*!< Exchange data on SPI bus failed */
    kStatus_SDSPI_WaitReadyFailed = 102,    /*!< Wait card ready failed */
    kStatus_SDSPI_ResponseError = 103,      /*!< Response is error */
    kStatus_SDSPI_WriteProtected = 104,     /*!< Write protected */
    kStatus_SDSPI_GoIdleFailed = 105,       /*!< Go idle failed */
    kStatus_SDSPI_SendCommandFailed = 106,  /*!< Send command failed */
    kStatus_SDSPI_ReadFailed = 107,         /*!< Read data failed */
    kStatus_SDSPI_WriteFailed = 108,        /*!< Write data failed */
    kStatus_SDSPI_SendInterfaceConditionFailed = 109, /*!< Send interface condition failed */
    kStatus_SDSPI_SendOperationConditionFailed = 110, /*!< Send operation condition failed */
    kStatus_SDSPI_ReadOcrFailed = 111,          /*!< Read OCR failed */
    kStatus_SDSPI_SetBlockSizeFailed = 112,     /*!< Set block size failed */
    kStatus_SDSPI_SendCsdFailed = 113,          /*!< Send CSD failed */
    kStatus_SDSPI_SendCidFailed = 114,          /*!< Send CID failed */
    kStatus_SDSPI_StopTransmissionFailed = 115, /*!< Stop transmission failed */
    kStatus_SDSPI_SendApplicationCommandFailed = 116, /*!< Send application command failed */
    kStatus_SDSPI_InvalidVoltage = 117, /*!< invaild supply voltage */
    kStatus_SDSPI_SwitchCmdFail = 118,  /*!< switch command crc protection on/off */
    kStatus_SDSPI_NotSupportYet = 119,  /*!< not support */
} status_t;
